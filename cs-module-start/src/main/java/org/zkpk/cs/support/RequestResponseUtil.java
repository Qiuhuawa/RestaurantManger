...
import org.zkpk.cs.support.xss.XssHttpServletRequestWrapper;
...
public class RequestResponseUtil {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static Map<String, Object> getObjectRequestBodyMap(ServletRequest request) {
		Map<String, Object> dataMap = new HashMap<String, Object>();
		// 判断是否已经将 inputStream 流中的 body 数据读出放入 attribute
		if (request.getAttribute("body") != null) {
			// 已经读出则返回attribute中的body
			return (Map<String, Object>) request.getAttribute("body");
		} else {
			try {
