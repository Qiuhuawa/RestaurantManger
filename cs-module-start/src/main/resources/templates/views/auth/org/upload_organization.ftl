...
<div class="modal fade" id="org-upload" data-keyboard="false" data-backdrop="static" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title pull-left" id="org-upload-modal-title">上传组织</h3>
            </div>
            <div class="modal-body">
            	<div class="step_one">
	                <form id="org-upload-form">
							...
							<div class="step_box">
								...
								<div class="upload-bottom">
									<ul class="upload_notes">
									    ...
									    <li>1.下载 &nbsp;<a class="down_demo" href="${ctx}/excel/downloadtemplate?fileName=orginfo.xlsx">组织导入模板</a></li>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-save" id="org-upload-button" name="uplad">上传</button>
                <button type="button" class="btn btn-save" id="org-reupload-button" name="reuplad" style="display:none;">重新导入</button>
