            ...
            <div id="data-table_wrapper" class="dataTables_wrapper">
                <div class="dataTables_buttons hidden-sm-down actions">
                    ...
                    <div class="dropdown actions__item">
                        <i data-toggle="dropdown" id="userdrop" class="zmdi zmdi-more-vert"></i>
                        <div class="dropdown-menu dropdown-menu-right">
                            <a href="javascript:void(0)" id="adduser" class="dropdown-item" data-toggle="modal" data-target="#user-add">新增用户</a>
                            <a href="javascript:void(0)" id="modifyuser" class="dropdown-item" onclick="updateUser()">修改用户</a>
                            <a href="javascript:void(0)" id="deletuser" class="dropdown-item" onclick="deleteUsers()">删除用户</a>
                        </div>
                    </div>
                </div>
